<!DOCTYPE html>
<!-- saved from url=(0050)http://endlesstheme.com/Perfect_Admin/profile.html -->
...
<div class="pace-activity"></div></div><div id="logoutConfirm_background" class="popup_background" style="opacity: 0; visibility: hidden; background-color: black; position: fixed; top: 0px; right: 0px; bottom: 0px; left: 0px; z-index: 2000; transition: all 0.3s;"></div><div id="logoutConfirm_wrapper" class="popup_wrapper" style="opacity: 0; visibility: hidden; position: fixed; overflow: auto; z-index: 2001; transition: all 0.3s; top: 0px; right: 0px; left: 0px; bottom: 0px; text-align: center; display: none;"><div class="custom-popup width-100 popup_content" id="logoutConfirm" data-popup-initialized="true" aria-hidden="true" role="dialog" aria-labelledby="open_68747962" style="opacity: 0; visibility: hidden; display: inline-block; outline: none; transition: all 0.3s; text-align: left; position: relative; vertical-align: middle;">
			...
			<ul class="nav-notification clearfix">
				<li class="dropdown">
					...
					<ul class="dropdown-menu message dropdown-1">
						...
						<li><a href="profile.html#">View all messages</a></li>					  
					</ul>
				</li>
				<li class="dropdown hidden-xs">
					...
					<ul class="dropdown-menu task dropdown-2">
						<li><a href="profile.html#">You have 4 tasks to complete</a></li>					  
						<li>
							<a href="profile.html#">
								<div class="clearfix">
						...
						<li><a href="profile.html#">View all tasks</a></li>					  
					</ul>
				</li>
				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" href="profile.html#">
					...
					<ul class="dropdown-menu notification dropdown-3">
						<li><a href="profile.html#">You have 5 new notifications</a></li>					  
						<li>
							<a href="profile.html#">
						...
						<li><a href="profile.html#">View all notifications</a></li>					  
					</ul>
				</li>
				<li class="profile dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><a tabindex="-1" href="profile.html#" class="theme-setting"><i class="fa fa-cog fa-lg"></i> Setting</a></li>
						<li class="divider"></li>
						<li><a tabindex="-1" class="main-link logoutConfirm_open" href="profile.html#logoutConfirm" data-popup-ordinal="0" id="open_68747962"><i class="fa fa-lock fa-lg"></i> Log out</a></li>
					</ul>
				</li>
			</ul>
		</div><!-- /top-nav-->
		...
		<aside class="fixed skin-6">
			<div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;"><div class="sidebar-inner scrollable-sidebar" style="overflow: hidden; width: auto; height: 100%;">
				<div class="size-toggle">
					...
					<a class="btn btn-sm pull-right logoutConfirm_open" href="profile.html#logoutConfirm" data-popup-ordinal="1" id="open_78176985">
...
<?php include("sidebar.php")?>					
			...
			</div><div class="slimScrollBar" style="background: rgb(0, 0, 0); width: 0px; position: absolute; top: 0px; opacity: 0.0278516; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 241.087px;"></div><div class="slimScrollRail" style="width: 0px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div></div><!-- /sidebar-inner scrollable-sidebar -->
		</aside>
		...
		<div id="main-container">
			...
			<ul class="tab-bar grey-tab">
				<li class="active">
					<a href="profile.html#overview" data-toggle="tab">
				...
				<li>
					<a href="profile.html#edit" data-toggle="tab">
						<span class="block text-center">
				...
				<li>
					<a href="profile.html#message" data-toggle="tab">
						<span class="block text-center">
					...
					<div class="col-md-3 col-sm-3">
						<div class="row">
							<div class="col-xs-6 col-sm-12 col-md-6 text-center">
								<a href="profile.html#">
									<img src="assets/user.jpg" alt="User Avatar" class="img-thumbnail">
								</a>
										...
										<div class="panel panel-default fadeInDown animation-delay3">
											...
											<ul class="list-group"> 
												<li class="list-group-item"> 
													<p>Welcome <a href="profile.html#" class="text-info">@John Doe</a> Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p> 
													<small class="block text-muted">
														<i class="fa fa-clock-o"></i> 6 minutes ago
													</small>
												</li> 
												<li class="list-group-item"> 
													<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. <a href="profile.html#" class="text-info">@Jand Doe</a></p> 
													<small class="block text-muted">
														<i class="fa fa-clock-o"></i> 41 minutes ago
													</small> 
												</li> 
												<li class="list-group-item"> <p><a href="profile.html#" class="text-info">@Bill Doe</a> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam eros nibh, viverra a dui a, gravida varius velit.</p> 
													<small class="block text-muted">
														<i class="fa fa-clock-o"></i> 1 hour ago
													</small> 
												</li> 
												<li class="list-group-item"> <p><a href="profile.html#" class="text-info">@John Doe</a> Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p> 
													<small class="block text-muted">
										...
										<tbody>
											<tr>
												<td class="text-center hidden-xs">
													<img data-src="holder.js/60x60" alt="60x60" src="data:image/png;base64," style="width: 60px; height: 60px;">
												</td>
